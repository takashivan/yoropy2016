...
func addOval() {
        ...
        ovalLayer.expand()
    NSTimer.scheduledTimerWithTimeInterval(0.1, target: self, selector: "wobbleOval",
    ...
    func drawAnimatedTriangle() {
        ...
        NSTimer.scheduledTimerWithTimeInterval(0.6, target: self, selector: "spinAndTransform",
            userInfo: nil, repeats: false)
    }
    ...
    func drawBlueAnimatedRectangle() {
        ...
        blueRectangleLayer.animateStrokeWithColor(Colors.green)
